...
import { getGame } from '../../redux/modules/game';
import { getCrossword } from '../../redux/modules/crossword';
...
export default withRouter(connect(mapStateToProps, { getAuthenticatedUser, getCrossword, getGame })(form(Game)));